...
router.get("/reset-password", accountController.getResetPasswordPage);
...
router.post(
  ...
  body("displayName")
    ...
    .isLength({ min: 8 })
    .withMessage("Display name must be at least 8 characters !"),
  body("phoneNumber")
    .exists()
...
router.put(
  ...
  body("password")
    ...
    .withMessage("Password is required !")
    .isLength({ min: 8 })
    .withMessage("Password must be greater then 8 characters !"),
  body("newPassword")
    .exists()
    .withMessage("New password is required !")
    .isLength({ min: 8 })
    .withMessage("New Password must be greater then 8 characters !"),
  body("confirmNewPassword")
    .exists()
    .withMessage("Confirm new password is required !")
    .isLength({ min: 8 })
    .withMessage("Confirm new password must be greater then 8 characters !")
    .custom((value, { req }) => {
