                ...
                <Box>
                    ...
                    <Box>
                        ...
                        <Stack flexDirection={'row'} justifyContent={"space-between"} sx={{ marginTop: '1rem' }}>
                            ...
                            >
                                {duration ? `${Math.floor(duration / (1000 * 60 * 60 * 24))} ngày ${Math.floor((duration % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60))} giờ ${Math.floor((duration % (1000 * 60 * 60)) / (1000 * 60))} phút` : 'Calculating duration...'}
                            </Typography>
                        </Stack>
                                    ...
                                    <Fragment key={index}>
                                        <StyledTableRow key={row.name} >
                                            ...
                                            <StyledTableCell align="left">
                                                {moment(row.booking_date.format('YYYY-MM-DD HH:mm'))}
                                            </StyledTableCell>
